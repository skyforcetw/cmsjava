...
//        Method method = Method.AB;
        ...
        boolean choiceFirstFor16 = false; //16�n�[�b����
//        boolean choiceFirstFor16 = true; //16�n�[�b����

        boolean plusAdjoin = true; //�O�_�n+1�b�۾F��frame
...
//            }
            ...
            try {
                frcList = frcPicker5(frameList, 0, 2, dir, false, false);
