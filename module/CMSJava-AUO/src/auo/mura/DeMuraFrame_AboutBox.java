 ...
 * @version 1.0
 */
public class DeMuraFrame_AboutBox
  ...
  public DeMuraFrame_AboutBox(Frame parent) {
    super(parent);
    try {
  ...
  private void jbInit() throws Exception {
    image1 = new ImageIcon(auo.mura.DeMuraFrame.class.getResource("about.png"));
