...
//    Meter ca210 = new DummyMeter();
    MeterMeasurement mm = new MeterMeasurement(ca210, false);

    try {
      for (; ; ) {
        System.in.read();
        //LCDTarget.Measured.measure(LCDTarget.Source.CA210,LCDTarget.Number.WHQL)
        ...
        CIEXYZ sRGBwhiteXYZ = RGB.ColorSpace.sRGB.referenceWhite.
            getNormalizeXYZ();
