...
//import vv.cms.lcd.material.AutoCPOptions;
...
import shu.cms.lcd.DisplayLUT;
import javax.swing.JOptionPane;
//import vv.cms.measure.cp.CPCodeLoader;
import shu.cms.devicemodel.lcd.LCDModel;
import java.awt.Color;

//import vv.cms.measure.cp.DarkFrame;
 ...
 * @version 1.0
 */
public class DigitalGammaLoader
    implements CPCodeLoader.LoaderInterface {
  public boolean loadCode(final RGB[] cpcodeArray, final RGB.MaxValue icBit) {
    if (i2c == null) {
      i2c = new I2C();
    }
    RGB[] cpcode = RGBArray.deepClone(cpcodeArray);
    RGBArray.changeMaxValue(cpcode, icBit);

    RGBArray.storeAUOExcel(cpcode, CPCodeLoader.EXCEL_FILE_NAME);
    i2c.frc_dg_en(AUOTcon, true, false);
    boolean result = i2c.write_lut(AUOTcon,
                                   new File(CPCodeLoader.EXCEL_FILE_NAME).
                                   getAbsolutePath());
