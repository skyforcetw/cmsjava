package vv.cms.lcd.calibrate.test;
...
public class AUOCalibrateTesterMain {
    ...
    private static class AUO9BitParameterProducer extends
            BasicParameterProducer {
...
//      mp.xtalkLCDTarget = LCDTarget.Number.Xtalk769;
        ...
        public ColorProofParameter.CCTCalibrate[] getCCTCalibrateArray() {
            ColorProofParameter.CCTCalibrate[] cctCalArray = new
                    ColorProofParameter.
                    CCTCalibrate[] {
    ...
    private static class AUOTestParameterProducer extends
            AUO10BitParameterProducer {
        public ColorProofParameter getInitCPParameter() {
            ColorProofParameter p = new ColorProofParameter();
...
//      mp.xtalkLCDTarget = LCDTarget.Number.Xtalk769;
    ...
    private static class AUO10BitParameterProducer extends
            BasicParameterProducer {
        public MeasureParameter getMeasureParameter() {
            MeasureParameter mp = new MeasureParameter();
...
//
//    CalibrateTester tester = new CalibrateTester(vv.cms.lcd.calibrate{
