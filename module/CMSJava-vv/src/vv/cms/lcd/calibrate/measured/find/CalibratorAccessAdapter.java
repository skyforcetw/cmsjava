 ...
 * @version 1.0
 */
public abstract class CalibratorAccessAdapter
    extends AlogorithmAdapter implements CalibratorAccessIF {
   ...
   * @deprecated
   */
  public CalibratorAccessAdapter(CIEXYZ white, CPCodeMeasurement cpm,
  ...
  public CalibratorAccessAdapter(CIEXYZ white, MeasureInterface mi,
                                 JNDIInterface jndi, DeltauvQuadrant quadrant,
                                 double maxCode, boolean forceTrigger) {
