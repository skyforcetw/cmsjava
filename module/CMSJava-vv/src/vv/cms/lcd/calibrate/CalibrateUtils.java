...
public class CalibrateUtils {
    ...
    public static class Crash {
        ...
        public final static boolean crashFix(RGB[] rgbArray,
            ...
            for (RGBBase.Channel ch : RGBBase.Channel.RGBChannel) {
                crashed = crashed ||
                          crashFix(rgbArray, ch, crashStartIndex, type);
            }
            return crashed;
        }
     ...
     * @return RGB[]
     */
    public final static RGB[] quantization(RGB[] rgbArray,
    ...
    public static void main(String[] args) {
        RGB[] rgbArray = new RGB[] {
                         new RGB(0, 0, 0), new RGB(1, 1, 1), new RGB(1, 1, 1),
                         new RGB(1, 1, 1),
    ...
    public final static void storeRGBArrayExcel(RGB[] rgbArray,
                                                String filename) {
        storeRGBArrayExcel(rgbArray, filename,
                           ColorProofParameter.Format.VastView,
    ...
    public final static void storeRGBArrayExcel(RGB[] rgbArray,
        ...
        storeRGBArrayExcel(rgbArray, filename, cp.outputFileFormat,
                           cp.outputBits);
    }

    public final static void storeRGBArrayExcel(RGB[] rgbArray,
                                                String filename,
                                                ColorProofParameter.Format
                                                format,
    ...
    public static class Delta {
         ...
         * @return double
         */
        public static double getDeltaxyYDistance(CIExyY target,
                                                 CIExyY reference) {
