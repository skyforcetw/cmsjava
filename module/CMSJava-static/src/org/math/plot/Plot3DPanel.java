...
public class Plot3DPanel
  ...
  public Plot3DPanel(double[] min, double[] max, String[] axesScales,
                     String[] axesLabels) {
  ...
  public int addBoxPlot(String name, Color c, double[][] XYdX) {
    return ( (Plot3DCanvas) plotCanvas).addBoxPlot(name, c,
        Array.getColumnsRangeCopy(XYdX, 0, 2),
  ...
  public int addHistogramPlot(String name, Color c, double[][] XYdX) {
    return ( (Plot3DCanvas) plotCanvas).addHistogramPlot(name, c,
        Array.getColumnsRangeCopy(XYdX, 0, 2),
  ...
  public int addHistogramPlot(String name, Color c, double[][] XY, int nX,
                              int nY) {
  ...
  public int addHistogramPlot(String name, Color c, double[][] XY,
    ...
    return ( (Plot3DCanvas) plotCanvas).addHistogramPlot(name, c, XY, boundsX,
        boundsY);
  }

  public int addHistogramPlot(String name, double[][] XY, double[] boundsX,
                              double[] boundsY) {
    return addHistogramPlot(name, getNewColor(), XY, boundsX, boundsY);
  }

  public int addHistogramPlot(String name, Color c, double[][] XY, double minX,
                              double maxX, int nX, double minY, double maxY,
                              int nY) {
    return ( (Plot3DCanvas) plotCanvas).addHistogramPlot(name, c, XY, minX,
        maxX, nX, minY, maxY, nY);
  }

  public int addHistogramPlot(String name, double[][] XY, double minX,
                              double maxX, int nX, double minY, double maxY,
                              int nY) {
    return addHistogramPlot(name, getNewColor(), XY, minX, maxX, nX, minY, maxY,
                            nY);
  }
  ...
  public int addCloudPlot(String name, Color color, double[][] sampleXYZ,
                          int nX, int nY, int nZ) {
    return ( (Plot3DCanvas) plotCanvas).addCloudPlot(name, color, sampleXYZ, nX,
        nY, nZ);
  }

  public int addCloudPlot(String name, double[][] sampleXYZ, int nX, int nY,
                          int nZ) {
  ...
  public void rotate(int vec0, int vec1) {
    ( (Plot3DCanvas) plotCanvas).rotate(vec0, vec1);
  }

  public void setView(double theta, double phi) {
    ( (Plot3DCanvas) plotCanvas).setView(theta, phi);
  }

  public void zoom(double wPercent, double hPercent) {
    this.plotCanvas.zoom(wPercent, hPercent);
  }
}
