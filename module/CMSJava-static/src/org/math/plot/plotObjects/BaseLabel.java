...
public class BaseLabel
    extends Label /* implements BaseDependant */ {
  ...
  public static void main(String[] args) {
    Plot3DCanvas p3d = new Plot3DCanvas(new double[] {0, 0, 0},
                                        new double[] {10, 10, 10},
    ...
    p3d.addPlotable(new BaseLabel("label", Color.RED, new double[] { -0.1, 0.5,
                                  0.5}));
  }
