...
public class RasterImage
  ...
  public RasterImage(Image img, float _alpha, double[] _xyzSW,
  ...
  public RasterImage(File _source, float _alpha, double[] _xyzSW,
                     double[] _xyzSE, double[] _xyzNW) {
    this(Toolkit.getDefaultToolkit().getImage(_source.getPath()), _alpha,
         _xyzSW, _xyzSE, _xyzNW);
    source = _source;
...
//    alpha = _alpha;
  ...
  public void setColor(Color c) {
    throw new IllegalArgumentException(
        "method not available for this Object: PlotImage");
  }
  ...
  public static void main(String[] args) {
    ...
    p2.addPlotable(new RasterImage(new File("test.gif"), 0.8f, new double[] {
      0.2, 0.5
    }, new double[] {
      1.2, 0.8
    }, new double[] {
    ...
    p.addPlotable(new RasterImage(new File("test.gif"), 0.5f, new double[] {
      0.0, 0.0, 0.0
    }, new double[] {
      1, 0, 0.0
    }, new double[] {
