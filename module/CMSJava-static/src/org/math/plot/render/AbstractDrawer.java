...
public abstract class AbstractDrawer {
  ...
  public final static int SQUARE_DOT = 3;

  public final static int CROSS2_DOT = 4;

  public final static int PATTERN_DOT = 0;

  public final static int NONE_DOT = 5;

  public final static int ARROW_DOT = 6;

  public final static int DOT_FILL_WHOLE = 1;

  public final static int DOT_FILL_INSIDE = 2;

  public final static int DOT_FILL_NONE = 3;

  public final static int DOT_FILL_GRADATION = 4;
  ...
  public final static boolean[][] DOT_TRIANGLE_PATTERN = stringToPattern("_",
      "___#___", "__#_#__", "__#_#__", "_#___#_", "_#___#_", "#######");

  public final static boolean[][] DOT_SQUARE_PATTERN = stringToPattern("_",
      "######", "#____#", "#____#", "#____#", "#____#", "######");
...
//      Font.PLAIN, 12);
  ...
  protected int dot_fill = DOT_FILL_WHOLE;
  ...
  public abstract void setGradient(double[] xy0, Color c0, double[] xy1,
                                   Color c1);
  ...
  public double[] getTextOffset() {
    return new double[] {
        text_Eastoffset, text_Northoffset};
  }
  ...
  public abstract void center(int ...t);
  ...
  public abstract void drawOval(double[] ...pC);

  public abstract void fillPolygon(float alpha, double[] ...pC);

  public abstract void drawImage(Image img, float alpha, double[] _xyzSW,
  ...
  public void setDotFill(int _dot_flll) {
    dot_fill = _dot_flll;
  }

  public int getDimension() {
    return canvas.base.dimension;
  }
   ...
   * @return int[][]
   */
  public abstract int[][] getBoundsSc();
}
