...
public class Projection2D
  ...
  protected double[] baseCoordsScreenProjectionRatio(double[] xy) {
    ...
    sC[0] = (xy[0] - draw.canvas.base.roundXmin[0]) /
        (draw.canvas.base.roundXmax[0] - draw.canvas.base.roundXmin[0]);
    sC[1] = (xy[1] - draw.canvas.base.roundXmin[1]) /
        (draw.canvas.base.roundXmax[1] - draw.canvas.base.roundXmin[1]);
