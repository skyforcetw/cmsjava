...
public class SetScalesFrame
    extends JFrame implements WindowFocusListener, WindowListener {
  ...
  public class ScalePanel
      extends JPanel implements StringPrintable {
    ...
    private void setTitle() {
      // System.out.println("title setting nï¿?" + numAxe + " : " +
      // title_field.getText());
      plotCanvas.setAxisLabel(numAxe, title_field.getText());
    }

    private void setBounds() {
      // System.out.println("bounds setting nï¿?" + numAxe + " : " +
    ...
    private void setScale() {
      // System.out.println("scale setting nï¿?" + numAxe + " : " + (
      // (log_check.isSelected()) ? ("LOG") : ("LINEAR")));
      try {
        plotCanvas.setAxiScale(numAxe,
                               (log_check.isSelected()) ? (Base.LOGARITHM) :
                               (Base.LINEAR));
      }
      catch (IllegalArgumentException iae) {
        JOptionPane.showConfirmDialog(null, iae.getMessage(), "Error",
    ...
    private void setBoundsAuto() {
      ...
      updateBoundsFields();
      // System.out.println("auto-Bounds setting nï¿?"+numAxe+" :
