...
public class BoxPlot3D
  ...
  public void plot(AbstractDrawer draw, Color c) {
    ...
    for (int i = 0; i < XY.length; i++) {
      draw.drawLine(new double[] {Xmin[i], Ymin[i], Zmin[i]},
      ...
      draw.drawLine(new double[] {Xmin[i], Ymin[i], Zmax[i]},
                    new double[] {Xmax[i], Ymin[i], Zmax[i]});
      draw.drawLine(new double[] {Xmax[i], Ymin[i], Zmax[i]},
                    new double[] {Xmax[i], Ymax[i], Zmax[i]});
      draw.drawLine(new double[] {Xmax[i], Ymax[i], Zmax[i]},
                    new double[] {Xmin[i], Ymax[i], Zmax[i]});
      draw.drawLine(new double[] {Xmin[i], Ymax[i], Zmax[i]},
                    new double[] {Xmin[i], Ymin[i], Zmax[i]});
