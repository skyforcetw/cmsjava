...
public class StatisticSample
  ...
  public static double[][] randomDirac(int m, int n, double[] values,
                                       double[] prob) {
    double[][] A = new double[m][n];
    for (int i = 0; i < A.length; i++) {
      for (int j = 0; j < A[i].length; j++) {
  ...
  public static double[][] randomLogNormal(int m, int n, double mu,
                                           double sigma) {
    double[][] A = new double[m][n];
    for (int i = 0; i < A.length; i++) {
      for (int j = 0; j < A[i].length; j++) {
  ...
  public static double[][] randomTriangular(int m, int n, double min,
                                            double max) {
    double[][] A = new double[m][n];
    for (int i = 0; i < A.length; i++) {
      for (int j = 0; j < A[i].length; j++) {
  ...
  public static double[] randomTriangular(int m, double min, double med,
                                          double max) {
    double[] A = new double[m];
    for (int i = 0; i < A.length; i++) {
  ...
  public static double[][] randomRejection(int m, int n, Function fun,
                                           double maxFun, double min,
                                           double max) {
    double[][] A = new double[m][n];
    for (int i = 0; i < A.length; i++) {
      for (int j = 0; j < A[i].length; j++) {
  ...
  public static double[] randomRejection(int m, Function fun, double maxFun,
