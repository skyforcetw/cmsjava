...
public abstract class Plot2D
  ...
  public abstract int addCirclePlot(String name, Color c, double[][] XYdxdY);

  public int addCirclePlot(String name, double[][] XYdxdY) {
    return addCirclePlot(name, getNewColor(), XYdxdY);
  }

  public final void addCacheLinePlot(String name, double start,
                                     double end, double y) {
    addCacheLinePlot(name, getNowCachePlotColor(), start, end, y);
  }

  protected class BoxCachePlot
      extends CachePlot {
    /**
     * BoxCachePlot
     *
  ...
  public final void addCacheLinePlot(String name, Color c, double start,
                                     double end, double y) {
  ...
  public final void addCacheBoxPlot(String name, double x,
                                    double y, double width, double height) {
    addCacheBoxPlot(name, getNowCachePlotColor(), x, y, width,
                    height);
  }

  public final void addCacheBoxPlot(String name, Color c, double x,
                                    double y, double width, double height) {
    double[] values = new double[] {
        x, y, width, height};
    checkParameter(name, values);
  ...
  public final void addCacheScatterPlot(String name, Color c, double x,
                                        double y) {
    addCacheScatterPlot(name, c, new double[] {x, y});
  }

  public final void addCacheScatterLinePlot(String name, double x,
                                            double y) {
    addCacheScatterLinePlot(name, getNowCachePlotColor(), x, y);
  }

  public final Color getNowCachePlotColor() {
//    System.out.println(cache.getCachePlotSize());
    return getNewColor(cache.getCachePlotSize());
  }

  public final void addCacheScatterLinePlot(String name, Color c, double x,
                                            double y) {
    addCacheScatterLinePlot(name, c, new double[] {x, y});
  }

  public final void addCacheScatterLinePlot(double x,
                                            double[] rgbValues) {
...
//  public final int addLinePlot(String name, Color c, double[] ...XY) {
//    return addLinePlot(name, c, XY);
//  }

  public final int addLinePlot(String name, double start, double end,
                               double[] Y) {
    return addLinePlot(name, this.getNewColor(), start, end, Y);
  }

  public final int addLinePlot(String name, Color c, double x1, double y1,
                               double x2, double y2) {
    return addLinePlot(name, c, new double[][] { {x1, x2}, {y1, y2}
    });
//    return addLinePlot(name, c, new double[][] { {x1, y1}, {x2, y2}
//    });
  }

  public final int addLinePlot(String name, double x1, double y1,
                               double x2, double y2) {
    return addLinePlot(name, this.getNewColor(), x1, y1, x2, y2);
  }

  public final int addLinePlot(String name, Color c, double start, double end,
                               double[] Y) {
    double[][] lineData = produceLineData(start, end, Y);
    return addLinePlot(name, c, lineData);
  }

  protected final static double[][] produceLineData(double XStart,
      double XEnd, double[] YData) {
...
//    h.setFixedBounds(0, 0, 1);
  ...
  public final int addScatterPlot(String name, double[] xAxis,
                                  double[] yAxis) {
    return addScatterPlot(name, new double[][] {xAxis, yAxis});
  }

  public final int addScatterPlot(String name, Color c, double[] xAxis,
                                  double[] yAxis) {
    return addScatterPlot(name, c, new double[][] {xAxis, yAxis});
  }

  public void addImage(Image img, float alpha, double[] originalSW,
                       double width) {
    double ratio = (double) img.getHeight(null) / img.getWidth(null);
    double height = width * ratio;
    double[] xySE = new double[] {
        originalSW[0] + width, originalSW[1]};
    double[] xyNW = new double[] {
        originalSW[0], originalSW[1] + height};
  ...
  public abstract int addHistogramPlot(String name, Color color,
                                       double[] sample, int n);
...
//  public abstract int addHistogramPlot(String name, Color c, double[][] XY,
//                                       double dX);
//
//  public final int addHistogramPlot(String name, double[][] XY, double dX) {
