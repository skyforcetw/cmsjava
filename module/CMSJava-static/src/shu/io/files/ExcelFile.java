...
public class ExcelFile
  ...
  public ExcelFile(File file, Mode mode) throws BiffException,
      IOException {
    this(file, null, mode);
  }

  public ExcelFile(String filename, Mode mode) throws BiffException,
      IOException {
    this(new File(filename), null, mode);
  }

//  public ExcelFile(InputStream is, Mode mode) throws BiffException,
//      IOException {
//    this(null, is, mode);
//  }

  public ExcelFile(InputStream is) throws BiffException,
      IOException {
...
//    sheet = workbook.getSheet(0);
  ...
  public ExcelFile(String filename, boolean create) throws BiffException,
      IOException {
    this(new File(filename), create);
  }

  public ExcelFile(File file, boolean create) throws BiffException,
      IOException {
  ...
  public ExcelFile(String readFilename, String writeFilename) throws
      IOException {
    this(new File(readFilename), new File(writeFilename));
  }

  public ExcelFile(File readFile, File writeFile) throws
      IOException {
  ...
  private ExcelFile(File file, InputStream is, Mode mode) throws
...
//    }
//    else if (cell instanceof jxl.write.Label) {
...
//    ExcelFile file = new ExcelFile("a.xls", Mode.Update);
    ExcelFile file = new ExcelFile("a.xls", "b.xls");
    for (int x = 0; x < 4; x++) {
//      System.out.println(file.getCell(0, x));
