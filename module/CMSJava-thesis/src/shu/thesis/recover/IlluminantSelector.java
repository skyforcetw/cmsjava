...
public class IlluminantSelector {
  public static void main(String[] args) {
    ...
    Spectra b50 = CorrelatedColorTemperature.getSpectraOfBlackbodyRadiator(5000).
        reduce(400, 700, 10);
    Spectra b55 = CorrelatedColorTemperature.getSpectraOfBlackbodyRadiator(5500).
        reduce(400, 700, 10);
    Spectra b65 = CorrelatedColorTemperature.getSpectraOfBlackbodyRadiator(6500).
        reduce(400, 700, 10);
    Spectra b75 = CorrelatedColorTemperature.getSpectraOfBlackbodyRadiator(7500).
        reduce(400, 700, 10);
    Spectra[] ill = new Spectra[] {
        D50, D65, A, F2, F8, F11, D55, D75
//        E, D50, D55, D65, D75, A, F2, F8, F11, b50, b55, b65, b75
    };
    int size = ill.length;
