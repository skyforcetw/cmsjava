...
//    int situation = getSituation();
  ...
  private void jbInit() throws Exception {
    ...
    jMenuFileExit.addActionListener(new
                                    PsychophysicsExperimentFrame_jMenuFileExit_ActionAdapter(this));
    jMenuHelp.setBackground(new Color(123, 123, 123));
    jMenuHelp.setText("Help");
    jMenuHelpAbout.setText("About");
    jMenuHelpAbout.addActionListener(new
                                     PsychophysicsExperimentFrame_jMenuHelpAbout_ActionAdapter(this));
    ...
    jButton_left.addActionListener(new
                                   PsychophysicsExperimentFrame_jButton1_actionAdapter(this));
    jButton_right.setEnabled(false);
    jButton_right.setText("右");
    jButton_right.addActionListener(new
                                    PsychophysicsExperimentFrame_jButton2_actionAdapter(this));
    ...
    jMenuItem_start.addActionListener(new
                                      PsychophysicsExperimentFrame_jMenuItem1_actionAdapter(this));
  ...
  void jMenuHelpAbout_actionPerformed(ActionEvent actionEvent) {
    PsychophysicsExperimentFrame_AboutBox dlg = new
        PsychophysicsExperimentFrame_AboutBox(this);
  ...
  public void jButton_left_actionPerformed(ActionEvent e) {
    try {
      fileWriter.write(df.format(pic) + "_" + df.format(leftMethod) + "/" +
                       df.format(pic) + "_" + df.format(rightMethod) + "/0\r\n");
      fileWriter.flush();
      if (!nextPicture()) {
        disableButton();
      }
  ...
  public void jButton_right_actionPerformed(ActionEvent e) {
    try {
      fileWriter.write(df.format(pic) + "_" + df.format(leftMethod) + "/" +
                       df.format(pic) + "_" + df.format(rightMethod) + "/1\r\n");
      fileWriter.flush();
      if (!nextPicture()) {
        disableButton();
      }
  ...
  protected final static int MAX_PIC = 7;
  protected final static int MAX_METHOD = 3;

  protected final static String PsychophysicsDir = "psychophysics";
  ...
  protected String getLeftPictureFilename() {
    //  01/00_00.jpg   ( situaiton/pic_method.jpg )
    return PsychophysicsDir + "/" + situation + "/" + df.format(pic) +
        "_" + df.format(leftMethod) + ".tif";
  }

  protected String getRightPictureFilename() {
    return PsychophysicsDir + "/" + situation + "/" + df.format(pic) +
        "_" + df.format(rightMethod) + ".tif";
  }
...
//    System.out.println(r+" "+selected);
    ...
    System.arraycopy(methodArray[remainderMethod - 1], 0, methodArray[selected],
                     0, 2);
    remainderMethod--;

    /*if (rightMethod + 1 >= MAX_METHOD) {
      if (leftMethod + 2 >= MAX_METHOD) {
        leftMethod = 0;
        if (pic + 1 >= MAX_PIC) {
          start = false;
          //====================================================================
    ...
    jLabel1.setText(++count + "/" +
                    (int) (MAX_PIC * Stat.binomialCoeff(MAX_METHOD, 2)));
  ...
  public void jMenuItem1_actionPerformed(ActionEvent e) {
    ...
    if (selection != null) {
      ...
      String name = this.jOptionPane1.showInputDialog(this, "請輸入你的姓名", "");

      Calendar rightNow = Calendar.getInstance();
      String filename = rightNow.get(Calendar.YEAR) +
          ...
          df.format(rightNow.get(Calendar.SECOND)) + "_" + name;

      outputFilename = PsychophysicsDir + "/" + situation +
...
//        jLabel1.setText(++count + "/" + (MAX_PIC * MAX_METHOD));
      }
      catch (IOException ex) {
        ex.printStackTrace();
      }
...
class PsychophysicsExperimentFrame_jMenuItem1_actionAdapter
    implements ActionListener {
  private PsychophysicsExperimentFrame adaptee;
  PsychophysicsExperimentFrame_jMenuItem1_actionAdapter(
...
class PsychophysicsExperimentFrame_jButton2_actionAdapter
    implements ActionListener {
  private PsychophysicsExperimentFrame adaptee;
  PsychophysicsExperimentFrame_jButton2_actionAdapter(
      PsychophysicsExperimentFrame adaptee) {
    this.adaptee = adaptee;
  }
...
class PsychophysicsExperimentFrame_jButton1_actionAdapter
    implements ActionListener {
  private PsychophysicsExperimentFrame adaptee;
  PsychophysicsExperimentFrame_jButton1_actionAdapter(
      PsychophysicsExperimentFrame adaptee) {
    this.adaptee = adaptee;
  }
...
class PsychophysicsExperimentFrame_jMenuFileExit_ActionAdapter
    implements ActionListener {
  PsychophysicsExperimentFrame adaptee;

  PsychophysicsExperimentFrame_jMenuFileExit_ActionAdapter(
      PsychophysicsExperimentFrame adaptee) {
    this.adaptee = adaptee;
  }
...
class PsychophysicsExperimentFrame_jMenuHelpAbout_ActionAdapter
    implements ActionListener {
  PsychophysicsExperimentFrame adaptee;

  PsychophysicsExperimentFrame_jMenuHelpAbout_ActionAdapter(
      PsychophysicsExperimentFrame adaptee) {
    this.adaptee = adaptee;
  }
