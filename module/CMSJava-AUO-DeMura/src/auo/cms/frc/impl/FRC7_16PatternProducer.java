...
//        String filename = "3_8frc-auo.txt";
        ...
        for (int x = 0; x < 1; x++) {
            main(0, dir, filename, true, true, true, x, inversion);
        }
    ...
    /**
     *
     * @param indexOfFRC int
     * @param dir String
     * @param frcFilename String
     * @param showBasicInfo boolean
     * @param showResult boolean
     * @param showFRCPatternOnly boolean
     * @param plusIndex int 指定+1的frame index
     * @throws IOException
     */
    public static void main(int indexOfFRC, String dir, String frcFilename, boolean showBasicInfo,
                            boolean showResult,
                            boolean showFRCPatternOnly, int plusIndex, ArtifactsAnalyzer.InversionMode inversion) throws
            IOException {
        ...
        if (new File(pickfilename).exists()) {
            ...
            try {
                frcList = frcPicker7(frameList, 0, 2, dir, false, false, inversion);
