 ...
 * @version 1.0
 */
public class LCDTargetFrame extends JInternalFrame {
//    extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        List<RGB>
                rgbList = LCDTarget.Instance.getRGBList(LCDTargetBase.Number.
                WHQL);
...
//      System.out.println(reminder);
            LCDTargetBase.Number number = LCDTargetBase.Number.
                                          getNumberFromReferenceFilenameAndDescription(
                                                  reminder);
...
//            String measureBits = (String)this.jComboBox_HighBits.
//                                 getSelectedItem();
