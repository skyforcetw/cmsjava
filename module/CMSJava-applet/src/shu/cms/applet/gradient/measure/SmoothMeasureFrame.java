...
//import shu.cms.devicemodel.lcd.material.*;
    ...
    protected void initInstr() {
        if (mm == null) {
            ...
            if (targetLogoFilename != null) {
                LCDTarget lcdTarget = LCDTarget.Instance.getFromLogo(
                        targetLogoFilename);
...
//        Meter m = Material.getMeter();
    ...
    private void measure(final RGBBase.Channel ch,
                         final boolean plotDeltaTarget) {
        ...
        new Thread() {
            public void run() {
                ...
                Plot2D plot = gm.plotPatternAccelInfo(null, true,
                        plotDeltaTarget);
                ...
                if (outputMessage) {
                    ...
                    System.out.println("ActualAccel: " +
                                       Arrays.toString(actualAccel));
                    System.out.println("MaxAndMinPrimeCode: " +
                                       Arrays.toString(getMaxAndMinPrimeCode(
                                               actualAccel)));
                    GSDFGradientModel.PatternAndScore pas = gm.
                            getPatternAndScore();
                ...
                SmoothMeasureInternalFrame iframe = new
                        SmoothMeasureInternalFrame(plot);
    ...
    public void jButton_MeasureW_actionPerformed(ActionEvent e) {
        measure(RGBBase.Channel.W,
                (targetChannel != null) ?
                targetChannel.equals(RGBBase.Channel.W) : true);
    }
