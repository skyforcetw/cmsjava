...
public class G2dSurfaceTrial {
  public static void main(String[] args) throws IOException,
    ...
    chart = getSurfaceChart(Quality.Intermediate, "swing"); //HistogramDemo.getChart();
    panel = new DoubleBufferedPanelAWT() {
      public void draw(Graphics g) {
        ...
        t.toc();
        System.out.println("(ms) Draw :" + t.elapsedMilisecond() + " for " +
                           proj.size() + " monotypes");
      }
  ...
  public static void openPanel(DoubleBufferedPanelAWT p, Rectangle bounds,
                               String title) {
