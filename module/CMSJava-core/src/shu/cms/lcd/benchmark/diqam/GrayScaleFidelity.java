 ...
 * @version 1.0
 */
public class GrayScaleFidelity extends DIQAM {
    ...
    public void report(double idealGamma) {
        ...
        double[] idealGammaCurve = calibrator.whiteCalibrate(idealGamma,
                RGB.White);
    ...
    public Plot2D getPlot() {
        ...
        double[] idealJNDICurvePrime = Maths.firstOrderDerivatives(
                idealJNDICurve);
...
class GammaCalibrator {
    public GammaCalibrator(LCDTarget lcdTarget) {
