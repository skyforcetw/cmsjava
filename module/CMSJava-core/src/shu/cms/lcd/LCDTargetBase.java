...
public abstract class LCDTargetBase extends Target {
    ...
    public final static class Calibrate {
        public final static void storeCalibration(LCDTarget referenceTarget,
            ...
            FourColorCalibrator calibrator = new FourColorCalibrator(
                    referenceTarget,
                    sampleTarget);
        ...
        public final static FourColorCalibrator loadFourColorCalibrator(
                LCDTarget
                sampleTarget) {
            String filename = produceCalibrationFilename(sampleTarget);
        ...
        public final static LCDTarget calibrate(LCDTarget sampleTarget) {
            FourColorCalibrator calibrator = loadFourColorCalibrator(
                    sampleTarget);
        ...
        protected final static String produceCalibrationFilename(LCDTarget
            ...
            LCDTarget.TargetIlluminant targetIlluminat = sampleTarget.
                    measureMetadata.
                    targetIlluminant;
    ...
    public static enum Device {
        ...
        EIZO_CE240W, EIZO_CG221, EIZO_CG221_2, EIZO_CG221_3, ViewSonic_VX2235WM
                , Dell_2407WFP_HC_normal, Dell_2407WFP_HC_custom,
        Dell_2407WFP_HC,
    ...
    final static class MeasureMetadata implements Serializable {
    ...
    public final static class Discrete {
        ...
        public final static int[] getDiscreteIndex(LCDTarget lcdTarget,
            ...
            deltaxyValuesArray[0] = Maths.firstOrderDerivatives(
                    deltaxyValuesArray[0]);
            deltaxyValuesArray[1] = Maths.firstOrderDerivatives(
                    deltaxyValuesArray[1]);
            if (plot) {
...
//      return intList.toArray();
        ...
        private final static double[] getDiscretePolarTarget(CIExyY blackxyY,
            ...
            targetValues = DoubleArray.plus(targetValues,
                                            new double[] {blackxyY.x,
                                            blackxyY.y});
            return targetValues;
        }
        ...
        private final static CIEXYZ getPureXYZ(CIEXYZ XYZ, int code,
                                               RGB.Channel ch,
                                               LCDModel model) {
...
//      double[] deltaxyValues = pureTargetxyY0.getDeltaxy(purexyY);
        ...
        private final static void fixDiscreteChromaticityByPolar(LCDTarget
            ...
            Patch originalPatch = (method == Method.PolarByWhite) ?
                                  lcdTarget.getWhitePatch() :
                                  lcdTarget.getBlackPatch();
            ...
            for (int discret : discretCodes) {
                ...
                shu.math.operator.Operator op = shu.math.operator.Operator.
                                                getAdjustOperator(new double[] {
                        originalxyY.x, originalxyY.y},
        ...
        public final static void fixDiscreteChromaticity(LCDTarget lcdTarget,
            ...
            case PolarByWhite:
            case PolarByBlack:
                fixDiscreteChromaticityByPolar(lcdTarget, ch, method,
                                               discretCodes);
                break;
            }
        }
    ...
    public final static class Operator {
         ...
         * @return boolean
         */
        public final static boolean checkIncreaseProgressively(LCDTarget
                lcdTarget) {
                ...
                for (int x = 1; x < size - 1; x++) {
                    ...
                    if (p.getXYZ().Y < pre.getXYZ().Y) {
                        ...
                        if (brighterIndex == -1) {
                            ...
                            Y = Interpolation.linear(preCode, nextCode,
                                    pre.getXYZ().Y,
                                    next.getXYZ().Y, code);
                        }
...
//      return lcdTarget;
    ...
    public final static class Measured {
        ...
        private final static LCDTarget measure0(MeterMeasurement
                                                meterMeasurement,
                                                List<RGB> rgbList,
...
//      if (lcdTarget.getNumber() != LCDTargetBase.Number.Unknow) {
            saveToLogoLog(lcdTarget,
                          System.currentTimeMillis() + "_" + numberName +
                          ".logo");
//      }
            //========================================================================
    ...
    final static class Filename {
        ...
        protected final static String produceFilename(String device,
            ...
            if (fileType == null) {
                ...
                case AUORampXLS:
                case VastViewXLS:
                    return produceNormalFilename(device, source, room,
                                                 illuminant,
                                                 number, fileType, dirTag,
                                                 fileTag);
                case VastView:
                    return produceVastViewTxTFilename(device, source, room,
                            illuminant,
                            number, dirTag, fileTag);
                case USB4000:
                    return produceUSB4000DIRName(device, source, room,
                                                 illuminant,
                                                 number, dirTag, fileTag);
                }
            }
        ...
        private final static String produceVastViewTxTFilename(String device,
            ...
            return CMSDir.Measure.Monitor + "/" + device + "/" +
                    source.name() + "/" +
                    room.name + "/" + illuminant.name() + "/" + dirname +
                    filename;
        }
...
//                   "Color Checker 24"),
         ...
         */
        private Number(int patchCount, String referenceFilename,
                       double step, String description,
...
//    }
        ...
        public final static int[] getIndexInComplex(Number complex,
                Number number) {
         ...
         * @return Number
         */
        public static Number getRamp256Number(RGBBase.Channel ch,
                                              boolean withWhite) {
    ...
    public final static class Instance {
        public final static LCDTarget getInterpolated(LCDTarget target,
            ...
            LCDTargetInterpolator interp = LCDTargetInterpolator.Instance.get(
                    target,
                    algos);
            TargetInterpolatorAdapter adapter = new TargetInterpolatorAdapter(
                    interp,
                    number);
        ...
        public final static LCDTarget getByPart(LCDTarget target,
            ...
            Patch.Filter.RGBInRange(patchList, tmp, RGBBase.Channel.R, start,
                                    end);
            Patch.Filter.RGBInRange(patchList, tmp, RGBBase.Channel.G, start,
                                    end);
            Patch.Filter.RGBInRange(patchList, tmp, RGBBase.Channel.B, start,
                                    end);
        ...
        public final static LCDTarget[] getInstancesFromLogoFiles(String
                dirName) {
            File dir = new File(dirName);
            String[] filenames = dir.list();
        ...
        private final static TargetAdapter getNumberTargetAdapter(Number number) {
            ...
            if (adapter1.getRGBList() != null) {
                ...
                if (is != null) {
                    LogoFileAdapter adapter2 = new LogoFileAdapter(new
                            InputStreamReader(
                                    is), filename);
                    return adapter2;
                } else {
        ...
        public final static LCDTarget get(TargetAdapter adapter, Number number) {
            ...
            case RGBXYZSpectra:
            case RGBSpectra:
                target = new LCDTarget(adapter.getSpectraList(),
                                       adapter.getRGBList(),
        ...
        private final static LCDTarget produceMultiLCDTarget(Source source,
            ...
            for (int x = 1; x < size; x++) {
                LCDTarget target = produceLCDTarget(source, numbers[x],
                        fileType,
                        filenames[x]);
        ...
        public final static LCDTarget getFromCA210Logo(String device,
                Number number,
                String dirTag) {
        ...
        public final static LCDTarget get(String device, Source source,
                                          ...
                                          String dirTag, String fileTag) {
            return get(device, source, Room.Dark, TargetIlluminant.Native,
                       number,
        ...
        public final static LCDTarget get(String device, Source source,
            ...
            if (multiTarget) {
                ...
                lcdTarget = produceMultiLCDTarget(source, number, fileType,
                                                  filenames);
            } else {
...
//        filter.rgbList();
        LCDTarget target = DC2LCDTargetAdapter.Instance.getCameraTarget(
                DCTarget.
                Chart.CC24,
                RGB.ColorSpace.sRGB);
//    target.lu
...
//        List<RGB> rgbList = new t
            rgbSet.addAll(getPlane(RGBBase.Channel.G, RGBBase.Channel.B, 0,
                                   step));
            rgbSet.addAll(getPlane(RGBBase.Channel.G, RGBBase.Channel.B, 255,
                                   step));
            rgbSet.addAll(getPlane(RGBBase.Channel.R, RGBBase.Channel.G, 0,
                                   step));
            rgbSet.addAll(getPlane(RGBBase.Channel.R, RGBBase.Channel.G, 255,
                                   step));
            rgbSet.addAll(getPlane(RGBBase.Channel.B, RGBBase.Channel.R, 0,
                                   step));
            rgbSet.addAll(getPlane(RGBBase.Channel.B, RGBBase.Channel.R, 255,
                                   step));
//      for (RGB rgb : rgbSet) {
...
//      }
        ...
        private final static List<RGB> getPlane(RGBBase.Channel first,
            ...
            RGBBase.Channel third = RGBBase.Channel.getBesidePrimaryChannel(
                    first,
                    second);
            List<RGB> rgbList = new LinkedList<RGB>();
