...
public class CXF {
  ...
  public static void main(String[] args) throws Exception {
    ...
    CXF cxf =
        (CXF) unmarshaller.unmarshal(new File("cxf/lcd.cxf"));
//    System.out.println(cxf.getAdditionalData().getValue().get(0).getName());
//    cxf.getConditions().get(0).setID("4");
