 ...
 * @version 1.0
 */
public class CLUTRegressionReverseModel extends LCDModel {
    ...
    public static class Factor extends LCDModel.Factor {
...
//  }
    ...
    public CLUTRegressionReverseModel(ColorSpaceConnectedLUT A2BClut,
        ...
        CIEXYZ modelWhite = new CIEXYZ(interpolation.getValues(RGB.White.
                getValues()));
    ...
    protected ColorSpaceConnectedLUT produceB2AClut() {
        ...
        ColorSpaceConnectedLUT B2A = new ColorSpaceConnectedLUT(inputChannels,
                outputChannels, grid, input, new double[] {0, 0, 0},
                new double[] {1, 1,
...
//    double[] XYZValues = fromXYZ(XYZ.getValues(), relativeXYZ);
        ...
        if (null != lcdTarget) {
            ...
            rgb = new RGB(RGB.ColorSpace.unknowRGB, result,
    ...
    protected Factor[] _produceFactor() {
        int size = cubeTable.getGrid(0) * cubeTable.getGrid(1) *
                   cubeTable.getGrid(2);
//    int size = (int) Math.pow(cubeTable.getGrid(), 3);
        ...
        Factor factor = new Factor(inverseRegression.getCoefs(),
                                   coefficientCount);
