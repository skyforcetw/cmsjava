...
//                                     double[] p1, double[] p2, double[] p3);
  ...
  private void addQuickHull3D(RGB2ColorSpaceTransfer transfer, Color c,
    ...
    for (int[] index : faceIndices) {
      ...
      if (c == null) {
        ...
        polygon = new PolygonPlot("", rgb.getColor(),
  ...
  public void addQuickHull3D(RGB2ColorSpaceTransfer transfer, QuickHull3D hull,
                             float alpha) {
...
//  public abstract int addPlot(Plot newPlot);
  ...
  public final static Plot3D getInstance() {
    return Plot3D.getInstance("Plot3D", 600, 600);
  }

  public final static Plot3D getInstance(String title, int width, int height,
                                         Instance instance) {

    shu.plot.Plot3D plot = shu.plot.Plot3D.getInstance(title, width, height,
        instance);
...
//    return plot;
  ...
  public final static Plot3D getInstance(String title, Instance instance) {
    return getInstance(title, 600, 600, instance);
  }

  public final static Plot3D getInstance(String title) {
...
//  }
  ...
  static class Plot3DWrapper
      extends Plot3D implements PlotWrapperInterface {
