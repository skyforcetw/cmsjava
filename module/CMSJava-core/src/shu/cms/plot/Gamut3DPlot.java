...
public class Gamut3DPlot {
     ...
     * @param height int
     */
    public Gamut3DPlot(String title, int width, int height) {
...
//                                Plot3D.Instance.JMathPlot3D);
    ...
    public Gamut3DPlot(Plot3D plot3D) {
        this.plot3D = plot3D;
    }
...
//    isjzy3D = false;
        ...
        case Triangle: {
            if (isjzy3D) {
                ...
                polygon.setWireframeColor(jzy3D.jzy3DColor(fillShape ?
                        Color.gray : c));
...
//    boolean skipBlack = true;
    ...
    public final static class RGB2XYZTransfer extends RGB2ColorSpaceTransfer {
        ...
        for (int h = 0; h <= 360; h += hStep) {
            ...
            for (int s = 0; s <= 100; s += sStep) {
                ...
                if (preArray2 != null && last2 != null) {
                    ...
                    OpponentColorAttribute c0 = (OpponentColorAttribute) last2.
                                                clone();
                    OpponentColorAttribute c1 = (OpponentColorAttribute) now.
                                                clone();
                    OpponentColorAttribute c2 = (OpponentColorAttribute) pre.
                                                clone();
                    OpponentColorAttribute c3 = (OpponentColorAttribute)
                                                nextPre.clone();
...
//    p.setAxisVisible(false);
    ...
    public final static class XYZ2LabTransfer implements ColorSpaceTransfer {
    ...
    public final static class XYZ2xyYTransfer implements ColorSpaceTransfer {
...
//    GamutPlot plot = new GamutPlot("", 600, 600);
        Gamut3DPlot plot = new Gamut3DPlot(plot3D);
