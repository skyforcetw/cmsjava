 ...
 * @version 1.0
 */
public abstract class Plot2D extends shu.plot.Plot2D {
...
//  }
    ...
    public final int addSpectra(String name, Color c, Spectra spectra) {
        double[][] lineData = produceLineData(spectra.getStart(),
                                              spectra.getEnd(),
                                              spectra.getData());
...
//    h.setFixedBounds(0, 0, 1);
    ...
    static class Plot2DWrapper extends Plot2D implements PlotWrapperInterface {
        ...
        public int addCirclePlot(String name, Color c, double[][] XYdxdY) {
            return plot.addCirclePlot(name, c, XYdxdY);
        }
