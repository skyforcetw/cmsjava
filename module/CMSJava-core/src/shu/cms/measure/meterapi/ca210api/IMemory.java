...
//		Dispatch.call(this, "ChannelID", lastParam);
//	}
   ...
   */
  public void getReferenceColor(String probeIDVal, float xVal, float yVal,
                                float lastParam) {
    Dispatch.call(this, "GetReferenceColor", probeIDVal, new Variant(xVal),
                  new Variant(yVal), new Variant(lastParam));
  }
  ...
  public void getReferenceColor(String probeIDVal, float[] xVal, float[] yVal,
    ...
    Dispatch.call(this, "GetReferenceColor", probeIDVal, vnt_xVal, vnt_yVal,
                  vnt_lastParam);
   ...
   * @param lastParam an input-parameter of type int
   */
  public void getMemoryStatus(int probeNOVal, int calProbeSNOVal,
                              int refProbeSNOVal, int lastParam) {
    Dispatch.call(this, "GetMemoryStatus", new Variant(probeNOVal),
                  new Variant(calProbeSNOVal), new Variant(refProbeSNOVal),
  ...
  public void getMemoryStatus(int probeNOVal, int[] calProbeSNOVal,
    ...
    Dispatch.call(this, "GetMemoryStatus", new Variant(probeNOVal),
                  vnt_calProbeSNOVal, vnt_refProbeSNOVal, vnt_lastParam);
  ...
  public int checkCalData(int probeNOVal, String lastParam) {
    return Dispatch.call(this, "CheckCalData", new Variant(probeNOVal),
                         lastParam).toInt();
  }
