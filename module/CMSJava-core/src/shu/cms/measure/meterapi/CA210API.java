...
public class CA210API {
  ...
  public final static double getAccuracy(Probe probe, double luminance) {
  ...
  private final static double[][] ACCURACY_ARRAY = new double[][] {
      {
      0.1, 5, 0.008}, {
      5, 40, 0.005}, {
      160, 160, 0.002}, {
  ...
  private final static double[][] SMALL_ACCURACY_ARRAY = new double[][] {
      {
      0.3, 15, 0.008}, {
      15, 120, 0.005}, {
      160, 160, 0.002}, {
  ...
  private final static double[][] REPEATABILITY_ARRAY = new double[][] {
      {
      0.1, 0.2, 0.015}, {
      0.2, 0.5, 0.008}, {
      0.5, 2, 0.003}, {
  ...
  private final static double[][] SMALL_REPEATABILITY_ARRAY = new double[][] {
      {
      0.3, 0.6, 0.015}, {
      0.6, 1.5, 0.008}, {
      1.5, 6.0, 0.003}, {
   ...
   */
  public final static double getxyRepeatabilityBySpecification(Probe probe,
      double luminance) {
  ...
  public void close() {
//    this.setRemoteMode(RemoteMode.OFF);
    memory.release();
    memory = null;
    probe.release();
    probe = null;
  ...
  public float[] triggerMeasurement() {
    ...
    float[] result = new float[] {
        probe.getX(), probe.getY(), probe.getZ()};
    return result;
  }
  ...
  public static enum AveragingMode {
    ...
    public final static AveragingMode getAveragingMode(int mode) {
      switch (mode) {
        case 0:
          return SLOW;
        case 1:
  ...
  public static enum CalStandard {
    ...
    public final static CalStandard getCalStandard(int mode) {
      switch (mode) {
        case 1:
          return CT6500K;
        case 2:
  ...
  public static enum RemoteMode {
    ...
    public final static RemoteMode getRemoteMode(int mode) {
      switch (mode) {
        case 0:
          return OFF;
        case 1:
  ...
  public static enum SyncMode {
    ...
    public final static SyncMode getSyncMode(int mode) {
      switch (mode) {
        case 0:
          return NTSC;
        case 1:
