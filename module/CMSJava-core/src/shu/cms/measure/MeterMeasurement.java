...
//  }
    ...
    public MeterMeasurement(Meter meter, DICOM dicom, double LCDSize,
                            boolean calibration) {
        this.meter = meter;
    ...
    protected Patch measure0(RGB rgb, String patchName, String titleNote,
        ...
        if (isAbnormalMode()) {
            JOptionPane.showMessageDialog(null,
                                          "unsupport operation in Argyll meter",
                                          "Unsupport operation",
    ...
    public List<Patch> measure(List<RGB> rgbList, List<String> patchNameList) {
        ...
        if (isAbnormalMode()) {
            ...
            for (int x = 0; x < size; x++) {
                ...
                String timeNote = "elapsed:" + elapsed +
                                  "(s)     estimate remain:" +
                                  remain + "(s)";
                Patch p = measure0(rgbList.get(x), name, index + "/" + size,
                                   timeNote);
                if (p == null) {
                    return patchList;
                }
...
//    mm.measure(new RGB(RGB.ColorSpace.unknowRGB, new int[] {10, 20, 30}), null);
        ...
        RGB[] rgbArray2 = new RGB[] {
                          new RGB(0, 0, 0), new RGB(252, 252, 252),
                          new RGB(253, 253, 253)};
        RGB[] rgbArray3 = new RGB[] {
                          new RGB(0, 0, 0), new RGB(251, 251, 251),
                          new RGB(252, 252, 252),
                          new RGB(253, 253, 253)};
        RGB[] rgbArray4 = new RGB[] {
                          new RGB(0, 0, 0), new RGB(254, 254, 254),
                          new RGB(253, 253, 253)};
