...
public class DebugAxeSnippet {
  public static void main(String[] args) throws IOException {
    ...
    Chart chart = getChart(mapper, range, steps, Quality.Nicest, "swing");
    ChartLauncher.openChart(chart, new Rectangle(0, 200, 800, 800), "Surface");
  }

  public static Chart getChart(Mapper mapper, Range range, int steps,
                               Quality quality, String type) {
