...
public class RGBSurface
  ...
  protected void calculate() {
    ...
    List<RGB> surfaceRGBList = LCDTargetBase.SurfaceTarget.getSurface(17);
...
//代表轉了一圈,所以要歸零
    ...
    for (int x = 0; x < LIndices.length; x++) {
      ...
      if (LChValues[1] > boundaryHLCArray[HIndex][LIndex]) {
        ...
        boundaryRGBArray[HIndex][LIndex][0] = (int) rgb.R;
        boundaryRGBArray[HIndex][LIndex][1] = (int) rgb.G;
        boundaryRGBArray[HIndex][LIndex][2] = (int) rgb.B;
      }
