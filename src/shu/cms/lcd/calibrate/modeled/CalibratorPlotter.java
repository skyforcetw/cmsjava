...
public class CalibratorPlotter {
  ...
  public void plot() {
    ...
    plotGamma(c.calibrateRGBArray,
              c.cp.gamma == ColorProofParameter.Gamma.Custom ? c.cp.customGamma :
              -1);
    //==========================================================================
  }
  ...
  private Plot2D plotRGBDeltaE(DeltaE[] rgbDeltaEArray) {
    ...
    for (int x = 0; x < size; x++) {
      ...
      plot.addCacheScatterLinePlot("dab", Color.green, x + 1,
...
//    Plot2D plot1D = Plot2D.getInstance("u' and v' diagram");
...
//      plot1D.addCacheLinePlot("ideal-u'", Color.red, 0, 255, idealuvp[0]);
//      plot1D.addCacheLinePlot("ideal-v'", Color.red, 0, 255, idealuvp[1]);
...
//      plot1D.addCacheLinePlot("actual-u'", Color.green, 0, 255, uvp[0]);
//      plot1D.addCacheLinePlot("actual-v'", Color.green, 0, 255, uvp[1]);
      ...
      plot.addCacheScatterLinePlot("native", Color.blue, nativeuvp[0],
                                   nativeuvp[1]);
//      plot1D.addCacheLinePlot("native-u'", Color.blue, 0, 255, nativeuvp[0]);
//      plot1D.addCacheLinePlot("native-v'", Color.blue, 0, 255, nativeuvp[1]);
...
//    plot1D.setAxeLabel(0, "code");
//    plot1D.setAxeLabel(1, "");
//    plot1D.drawCachePlot();
//    plot1D.addLegend();
//    plot1D.setVisible();
    ...
    double[][] duvpArray = new LCDModelCalibrateReporter(c).
        getEstimateDeltauvPrime();
...
//      plot.addCachexyLinePlot("ideal", Color.red, idealuvp[0], idealuvp[1]);
      //      plot1D.addCacheLinePlot("ideal-u'", Color.red, 0, 255, idealuvp[0]);
      //      plot1D.addCacheLinePlot("ideal-v'", Color.red, 0, 255, idealuvp[1]);
