...
//    }
  ...
  private void drawGammas(String filename) {
    ...
    double[] grayGammas = GammaFinder.findingGammas(GammaFinder.NormalInput,
        grayCurve);
    double[] redGammas = GammaFinder.findingGammas(GammaFinder.NormalInput,
        redCurve);
    double[] greenGammas = GammaFinder.findingGammas(GammaFinder.NormalInput,
        greenCurve);
    double[] blueGammas = GammaFinder.findingGammas(GammaFinder.NormalInput,
        blueCurve);
  ...
  private String calculateGamma(boolean calculateGreen) {
    ...
    double gamma = GammaFinder.findingGamma(GammaFinder.NormalInput, normal);
    double cptGamma1 = GammaFinder.findingGammaCPT1(GammaFinder.NormalInput,
        normal);
    double cptGamma2 = GammaFinder.findingGammaCPT1(GammaFinder.NormalInput,
        normal);
