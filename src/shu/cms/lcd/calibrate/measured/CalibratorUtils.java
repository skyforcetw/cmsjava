 ...
 * @deprecated
 */
public abstract class CalibratorUtils {
  /**
  ...
  final static double[] getDeltaE(CIEXYZ center, CIEXYZ XYZ,
                                  CIEXYZ white) {
    DeltaE de = new DeltaE(center, XYZ, white, true);
    return new double[] {
        de.getCIEDeltaE()};
  ...
  final static double[] getDeltaEuv(CIEXYZ center, CIEXYZ XYZ,
                                    CIEXYZ white) {
...
//    DeltaE de = new DeltaE(center, XYZ, white, true);
  ...
  final static double[] getDeltaE00Weighting211(CIEXYZ center,
   ...
   * @return Number
   */
  protected final static LCDTargetBase.Number getMeasureNumber(RGBBase.Channel
    ...
    if (ramp256Measure) {
      ...
      return LCDTargetBase.Number.FiveColor;
    }
  }
   ...
   * @return RGB[]
   */
  protected final static RGB[] getMeasureRGBArray(final RGB[] rgbArray,
                                                  RGBBase.Channel
                                                  measureChannel) {
