...
//  }
  ...
  public RGB[] produceExperimentTarget(RGBBase.Channel ch,
                                       ...
                                       double maxCode, double occurjndi,
                                       double deltajndi) {
    return produceExperimentTarget(ch, maxValue, maxCode, occurjndi, deltajndi,
                                   -1);
  }
  ...
  public RGB[] produceExperimentTarget(RGBBase.Channel ch,
    ...
    System.arraycopy(calibratedActualJNDIArray, 0, experimentTargetJNDIArray, 0,
                     size);
...
//                                              fileType,
//                                              dirtag, tag);
    LCDTarget target = Material.getStoredLCDTarget().targetFilter.getRamp1021();
    LCDTarget.Operator.gradationReverseFix(target);

    DICOMCalibrator dicom = new DICOMCalibrator(target);
    RGB[] rgbArray = dicom.calibrate(RGBBase.Channel.W, RGB.MaxValue.Int12Bit,
                                     254);
