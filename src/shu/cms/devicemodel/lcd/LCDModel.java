 ...
 * @version 1.0
 */
public abstract class LCDModel
   ...
   */
  private LCDModel(CIEXYZ flare, CIEXYZ RMax, CIEXYZ GMax, CIEXYZ BMax,
                   Factor[] factors) {
  ...
  public LCDModel(LCDModelFactor factor) {
    ...
    this.flare.flareXYZ = new CIEXYZ(flare.flareValues, factor.targetWhitePoint);
    this.max = factor.max;
  ...
  protected LCDModel(LCDTarget lcdTarget, LCDTarget rCorrectLCDTarget,
    ...
    this(LCDModelUtil.evaluateFlare(FLARE_TYPE, lcdTarget),
...
//      covert = new ReverseModelCovert(this, ReverseModelCovert.Mode.Around);
  ...
  protected CIEXYZ getXYZ(RGB rgb, LCDModel.Factor[] factor,
    ...
    RGB.MaxValue targetMaxValue = (null != lcdTarget) ? lcdTarget.getMaxValue() : null;
