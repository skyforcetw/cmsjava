...
public class ReverseModelCovert {
  ...
  public ReverseModelCovert(LCDModel lcdModel, Mode mode) {
    ...
    this.mode = mode;
//    step = lcdModel.getLCDTarget().getStep();
//    step = step == -1 ? RGB.MaxValue.Int11Bit.getStepIn255() : step;
...
//      RGB whiteRGB = (RGB) RGB.White.clone();
...
//      CPCodeLoader.setDummyLCDModel(lcdModel);
//      CPCodeLoader.setDummyLoading(true);
