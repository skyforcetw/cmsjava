 ...
 * @version 1.0
 */
public class SmoothMeasureFrame
    extends JFrame {
  ...
  public SmoothMeasureFrame(String targetLogoFilename, Meter meter,
                            RGBBase.Channel targetChannel) {
...
//    this.setVisible(true);
  ...
  private final static RGBBase.Channel getTargetChannel(LCDTarget lcdTarget) {
  ...
  private void jbInit() throws Exception {
    ...
    jButton_CPCode.setEnabled(AutoCPOptions.get("DummyMeter"));
  ...
  public static void main(String[] args) {
    Meter m = Material.getMeter();
//    Meter m = null;
//    if (AutoCPOptions.get("Test")) {
//      Material.setMeasureParameter(new MeasureParameter());
//      m = Material.getMeter();
////      m = new DummyMeter(RGB.ColorSpace.sRGB, 500,
////                         RGB.toXYZ(RGB.White, RGB.ColorSpace.sRGB));
//    }
//    else {
//      m = RemoteMeter.getDefaultInstance();
//    }
//    SmoothMeasureFrame frame = new SmoothMeasureFrame(
//        "[MEAS]-1-Relative-[JNDICalibrator].logo", m, RGBBase.Channel.G);
    SmoothMeasureFrame frame = new SmoothMeasureFrame(null, m,
        RGBBase.Channel.G);
    frame.setVisible(true);

//    if (m instanceof DummyMeter) {
//      RGB[] rgbArray = CalibrateUtil.loadRGBArrayExcel("[JNDI]-2-MinDelta.xls");
//      DummyMeter dm = (DummyMeter) m;
...
//    }
  ...
  private void measure(final RGBBase.Channel ch, final boolean plotDeltaTarget) {
    ...
    new Thread() {
      public void run() {
        LCDTargetBase.Number number = LCDTargetBase.Number.getRamp256Number(
            ch, true);
        ...
        String title = ch.toString() +
            ( (cpcodeFilename != null) ? " " + cpcodeFilename : "");
        plot.setTitle(title);
        ...
        if (outputMessage) {
          ...
          System.out.println("MaxAndMinPrimeCode: " +
                             Arrays.toString(getMaxAndMinPrimeCode(actualAccel)));
  ...
  public void jButton_MeasureW_actionPerformed(ActionEvent e) {
    measure(RGBBase.Channel.W,
            (targetChannel != null) ? targetChannel.equals(RGBBase.Channel.W) : true);
  }
  ...
  public void jButton_MeasureR_actionPerformed(ActionEvent e) {
    measure(RGBBase.Channel.R,
            (targetChannel != null) ? targetChannel.equals(RGBBase.Channel.R) : false);
  }

  public void jButton_MeasureG_actionPerformed(ActionEvent e) {
    measure(RGBBase.Channel.G,
            (targetChannel != null) ? targetChannel.equals(RGBBase.Channel.G) : false);
  }

  public void jButton_MeasureB_actionPerformed(ActionEvent e) {
    measure(RGBBase.Channel.B,
            (targetChannel != null) ? targetChannel.equals(RGBBase.Channel.B) : false);
  }
