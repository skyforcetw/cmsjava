...
public class MeasureToolFrame
  ...
  protected ImageIcon image_Configuring = new ImageIcon(shu.cms.applet.measure.
  ...
  private SaveAsVastViewAction saveAsVastViewAction = new SaveAsVastViewAction(
      "Save As VasiView");
  ...
  protected class Binder
      extends Calibrator.ServerBinder {
...
//    System.setProperty("swing.aatext", "true");
  ...
  private void jbInit() throws Exception {
    ...
    jFileChooserSaveVastView.removeChoosableFileFilter(jFileChooserSaveVastView.
        getAcceptAllFileFilter());
...
//  }
  ...
  protected class DeleteCalibrateAction
  ...
  protected class ComputeCalibrateAction
      extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      MeasuredInternalFrame selectedInternalFrame = (MeasuredInternalFrame)
          selectedFrame;
  ...
  protected class CharacterizeAction
      extends AbstractAction {
...
//        instrConfigFrame.addVetoableChangeListener(this);
  ...
  protected class MeasureAction
      extends AbstractAction implements ComponentListener {
     ...
     */
    public MeasureAction(String name, Icon icon, Frame owner, boolean hiBits) {
      super(name, icon);
      this.owner = owner;
      this.hiBits = hiBits;
    }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (hiBits) {
        lcdTargetFrame = new LCDTargetFrame("Test Chart Measurement", 300,
    ...
    protected SwingWorker getSwingWorker(final AppMeasureParameter mp) {
      ...
      SwingWorker worker = new SwingWorker<List<Patch>, Void> () {
        ...
        public List<Patch> doInBackground() {
          ...
          mm = new MeterMeasurement(mp);
          mm.setMeasureWindowsVisible(true);

          if (mp.firstBatch) {
            //如果是batch的第一個
            final Object lock = new Object();
            TinyDialog.Dialog d = TinyDialog.getStartDialogInstance(owner,
                "Start Measuring",
                new ActionListener() {
              public void actionPerformed(ActionEvent e) {
                synchronized (lock) {
          ...
          if (mp.measureBits != MeasureBits.EightBits) {
            HighBitsMeasurement hbm = new HighBitsMeasurement(mm, mp.icBits);
        ...
        protected void done() {
          ...
          if (result != null) {
            ...
            if (whitePatch != null) {
              result = Patch.Produce.LabPatches(result, whitePatch.getXYZ());
            }
            LCDTargetBase.Number number = (mp.lcdTarget != null) ?
                mp.lcdTarget.getNumber() : mp.targetNumber;
            LCDTarget lcdTarget = LCDTarget.Instance.get(result, number,
                mp.inverseMode);
...
//            jMenuItem_SaveAs.setEnabled(true);
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (frame != null) {
        ...
        if (saveFile != null) {
          ...
          String saveFilename = saveFile(saveFile.getAbsolutePath(), filter,
                                         frame.lcdTarget);
  ...
  protected class SaveAsVastViewAction
      extends AbstractAction {
...
//      List<Patch> patchList = lcdTarget.getPatchList();
  ...
  protected class ConfigAction
      extends AbstractAction implements VetoableChangeListener {
