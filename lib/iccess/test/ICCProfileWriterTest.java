...
public class ICCProfileWriterTest extends TestCase
{
	private ICCProfileWriter	data_;
  private String  testfile_ = "testwriter.icc";
	...
	public void testConstructors()
	{
		try
		{
			ICCProfileWriter inst1 = new ICCProfileWriter(testfile_);
	...
	private ICCProfileWriter createFile(String filename)
	{
		try
		{
	...
	{
		ICCProfileWriter writer = createFile(testfile_);
