...
/**
 * LutBtoAType is a tag type for B-to-A mapping table.
 * 
 * @author Ted Wen
 * @version 0.1
 * @update 2006-10-29
 ...
 * one dimensional curves, a multidimensional lookup table, and a set of one dimensional output curves.
 * 
 * 0..3		4	'mBA ' (6D424120h) [multi-function B-toA table] type signature
 ...
 * 32..end		Data
 */
public class LutBtoAType extends AbstractTagType
{
	public static final int SIGNATURE = 0x6D424120;
	...
	public LutBtoAType()
	{
		this.signature_ = new Signature(SIGNATURE);	//"mBA ");
	}

	public LutBtoAType(byte[] byteArray) throws ICCProfileException
	{
	...
	public void fromByteArray(byte[] byteArray, int offset, int len) throws ICCProfileException
	{
		...
		if (this.signature_.intValue() != 0x6D424120)
	...
	public String toXmlString(String name)
	{
		...
		if (name==null || name.length()<1)
			sb.append("<lutBtoAType sig=\"\">");
		else
			sb.append("<lutBtoAType name=\""+name+"\" sig=\"\">");
