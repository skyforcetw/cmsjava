...
public class ColorSpace extends UInt32Number {
    public static final int XYZ_DATA = 0x58595A20; //'XYZ '
    public static final int LAB_DATA = 0x4C616220; //'Lab '
    public static final int LUV_DATA = 0x4C757620; //'Luv'
    public static final int YCBCR_DATA = 0x59436272; //'YCbr'
    public static final int YXY_DATA = 0x59787920; //'Yxy'
    public static final int RGB_DATA = 0x52474220; //'RGB'
    public static final int GRAY_DATA = 0x47524159; //'GRAY'
    public static final int HSV_DATA = 0x48535620; //'HSV '
    public static final int HLS_DATA = 0x484C5320; //'HLS '
    public static final int CMYK_DATA = 0x434D594B; //'CMYK'
    public static final int CMY_DATA = 0x434D5920; //'CMY '
    public static final int COLOR2_DATA = 0x32434C52; //'2CLR'
    public static final int COLOR3_DATA = 0x33434C52; //'3CLR'
    public static final int COLOR4_DATA = 0x34434C52; // '4CLR'
    public static final int COLOR5_DATA = 0x35434C52; // '5CLR'
    public static final int COLOR6_DATA = 0x36434C52; // '6CLR'
    public static final int COLOR7_DATA = 0x37434C52; // '7CLR'
    public static final int COLOR8_DATA = 0x38434C52; // '8CLR'
    public static final int COLOR9_DATA = 0x39434C52; // '9CLR'
    public static final int COLOR10_DATA = 0x41434C52; // 'ACLR'
    public static final int COLOR11_DATA = 0x42434C52; // 'BCLR'
    public static final int COLOR12_DATA = 0x43434C52; // 'CCLR'
    public static final int COLOR13_DATA = 0x44434C52; // 'DCLR'
    public static final int COLOR14_DATA = 0x45434C52; // 'ECLR'
    public static final int COLOR15_DATA = 0x46434C52; // 'FCLR'
